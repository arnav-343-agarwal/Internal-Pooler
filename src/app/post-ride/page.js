      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input name="maxSeats" type="number" placeholder="Max Seats" value={form.maxSeats} onChange={handleChange} required />
            <Textarea name="description" placeholder="Optional Description" value={form.description} onChange={handleChange} />
